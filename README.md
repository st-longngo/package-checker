...
✅ **All packages in the `dependencies` and `devDependencies` of this project are NOT affected by the affected packages list.** The project's dependencies are safe and secure to use.

This tool is designed to check your own `package.json` files against the affected packages database. The tool itself is built with secure, verified packages.
